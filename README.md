...
Были заведены [баг-репорты](https://github.com/julia-ju25/testing_hexlet_friends/blob/main/test-cases.pdf](https://github.com/julia-ju25/testing_hexlet_friends/blob/main/bugreports.yml) на обнаруженные дефекты.
